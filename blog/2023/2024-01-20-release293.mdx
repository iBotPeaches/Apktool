...
- [[#3492](https://github.com/iBotPeaches/Apktool/pull/3492)] Fix [#GHSA-vgwr-4w3p-xmjv](https://github.com/iBotPeaches/Apktool/security/advisories/GHSA-vgwr-4w3p-xmjv) (Arbitrary file writes on Windows). (Thanks Cl0udG0d)
