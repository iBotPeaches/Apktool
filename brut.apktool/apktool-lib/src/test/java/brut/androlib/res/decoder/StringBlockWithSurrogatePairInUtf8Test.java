...
public class StringBlockWithSurrogatePairInUtf8Test {
    ...
    public void decodeSingleOctet() {
        final String actual =
                new StringBlock("abcDEF123".getBytes(StandardCharsets.UTF_8), true)
                        .decodeString(0, 9);
    ...
    public void decodeTwoOctets() {
        final String actual0 =
                new StringBlock(new byte[] {(byte) 0xC2, (byte) 0x80}, true).decodeString(0, 2);
        assertEquals("Incorrect decoding", "\u0080", actual0);

        final String actual1 =
                new StringBlock(new byte[] {(byte) 0xDF, (byte) 0xBF}, true).decodeString(0, 2);
    ...
    public void decodeThreeOctets() {
        final String actual0 =
                new StringBlock(new byte[] {(byte) 0xE0, (byte) 0xA0, (byte) 0x80}, true)
                        .decodeString(0, 3);
        assertEquals("Incorrect decoding", "\u0800", actual0);

        final String actual1 =
                new StringBlock(new byte[] {(byte) 0xEF, (byte) 0xBF, (byte) 0xBF}, true)
                        .decodeString(0, 3);
        assertEquals("Incorrect decoding", "\uFFFF", actual1);
    }
    ...
    public void decodeSurrogatePair_when_givesAsThreeOctetsFromInvalidRangeOfUtf8() {
        ...
        final byte[] bytesWithCharactersBeforeSurrogatePair = {
            'G',
            'o',
            'o',
            'd',
        ...
        final String actual2 =
                new StringBlock(bytesWithCharactersBeforeSurrogatePair, true).decodeString(0, 31);
