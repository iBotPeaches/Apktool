...
/**
 * Implementation of XmlSerializer interface from XmlPull V1 API. This implementation is optimized
...
public class MXSerializer implements XmlSerializer {
    ...
    private static final int BUF_LEN =
            Runtime.getRuntime().freeMemory() > 1000000L ? 8 * 1024 : 256;
    ...
    protected void writeElementContent(String text, Writer out) throws IOException {
        ...
        // For some reason, some non-empty, empty characters are surviving this far and getting
        // filtered out
